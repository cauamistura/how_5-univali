...
class AuthController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($authenticatedUser->id != $id) {
                return response()->json(['error' => 'Você não tem permissão para atualizar este usuário'], Response::HTTP_FORBIDDEN);
            }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            return response(["error" => "Credenciais inválidas"], Response::HTTP_UNAUTHORIZED);
        }
    }
    ...
    public function logout()
    {
        ...
        return response(["message" => "Log out feito"], Response::HTTP_OK)->withCookie($cookie);
    }
